...
{
    public abstract class B12TestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static B12TestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(B12TestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<B12TestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<B12TestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<B12TestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<B12TestDbContext, Task<T>> func)
        {
            T result;
